	...
	<form action='update.do' method='post'>
		<ul>
			...
			<li>
				...
				<input id="sdate" type="text" name="startDate"
					placeholder="예)2020-04-01"
					value="${project.startDate}">
			</li>
			<li>
				<label for="edate">종료일</label>
				<input id="edate" type="text" name="endDate"
			...
			<li>
				...
				<select id="state" name="state">
					<option value="0"
						...
						준비</option>
					<option value="1"
						${project.state==1?"selected":""}>
						진행</option>
					<option value="2"
						${project.state==2?"selected":""}>
						완료</option>
					<option value="3"
						${project.state==3?"selected":""}>
						취소</option>
				</select>
			</li>
			<li>
